(function () {
  window.COURSE = {
    meta: {
      description:
        "15개의 Flask 강의 노트북을 번호별 웹 학습 페이지로 재구성했습니다. \n원래 흐름은 유지하면서 예제, 실습, 운영 관점, 보안과 설계 판단을 보강했습니다.",
      examples: "15+",
    },
    sources: [
      {
        label: "Flask 공식 문서 3.1.x",
      ...
      {
        label: "Flask-Login Documentation",
        url: "https://flask-login.readthedocs.io/",
      },
      {
        label: "Flask-CORS Documentation",
      ...
      {
        label: "Flask-SQLAlchemy Documentation",
        url: "https://flask-sqlalchemy.readthedocs.io/en/stable/",
      },
      {
        label: "PyMongo Documentation",
    ...
    lessons: [
      {
        ...
        focus:
          "프론트엔드와 백엔드가 어떻게 계약을 맺고, Flask가 그 계약을 빠르게 구현하게 해주는지 이해합니다.",
        objectives: [
...
# flask --app app run --debug`,
        ...
        practice: {
          title: "요청-응답 지도 만들기",
          prompt:
            "간단한 프로필 API를 만든다고 가정하고 브라우저부터 DB까지 어떤 정보가 이동하는지 적어보세요.",
          steps: [
        ...
        quiz: [
          {
            q: "Flask가 마이크로 프레임워크라는 말은 기능이 약하다는 뜻일까?",
            a: "아닙니다. 핵심 기능을 작게 제공하고 필요한 확장을 선택하게 한다는 뜻입니다.",
          },
          {
            q: "프론트엔드와 백엔드 사이의 가장 중요한 계약은 무엇인가?",
            a: "URL, HTTP 메서드, 요청 데이터, 응답 형식, 상태 코드입니다.",
          },
        ],
      },
      {
        ...
        focus:
          "Flask 앱을 만들고 실행하는 흐름, URL과 함수를 연결하는 라우팅, 파이썬 엔트리포인트의 의미를 정확히 잡습니다.",
        objectives: [
...
# flask --app app:create_app run --debug`,
        ...
        quiz: [
          {
            q: "__name__이 Flask 앱 생성에 쓰이는 이유는?",
            a: "현재 모듈의 위치를 기준으로 템플릿과 static 파일 등 애플리케이션 리소스를 찾기 위해서입니다.",
          },
          {
            q: "debug=True를 운영에 쓰면 안 되는 이유는?",
            a: "상세 오류와 디버거가 노출되어 보안 위험이 커지고, 개발 서버 자체도 운영 부하와 안정성을 목표로 하지 않기 때문입니다.",
          },
        ],
      },
      {
        ...
        focus:
          "Flask의 @app.route를 자연스럽게 이해하기 위해 파이썬 함수가 값처럼 다뤄지는 방식을 익힙니다.",
        objectives: [
...
def report():
    return {"sales": 128, "active_users": 42}`,
        ...
        practice: {
          ...
          prompt:
            "어떤 함수가 몇 ms 걸렸는지 출력하는 데코레이터를 작성하고 Flask 라우트에 붙여보세요.",
          steps: [
        ...
        quiz: [
          {
            q: "클로저가 데코레이터에서 유용한 이유는?",
            a: "외부 함수의 설정값을 wrapper가 기억하게 만들 수 있어 옵션이 있는 공통 처리를 만들기 좋기 때문입니다.",
          },
          {
            q: "@app.route와 커스텀 데코레이터의 순서가 중요한 이유는?",
            a: "어떤 함수가 Flask에 등록되는지, 요청 시 어떤 wrapper가 먼저 실행되는지가 달라질 수 있기 때문입니다.",
          },
        ],
      },
      {
        ...
        tags: ["REST", "HTTP", "JSON"],
        focus:
          "정적 HTML 반환에서 시작해 JSON API, 상태 코드, 메서드별 의미, 프론트엔드 연동까지 확장합니다.",
        objectives: [
...
def update_todo(todo_id):
    ...
    return todos[todo_id]`,
        ...
        practice: {
          title: "에러 포맷 통일하기",
          prompt:
            "위 Todo API에 JSON 에러 핸들러를 추가해 모든 오류가 같은 구조로 나오게 만드세요.",
          steps: [
        ...
        quiz: [
          {
            q: "POST 생성 성공에 201을 쓰는 이유는?",
            a: "클라이언트에게 새 리소스가 생성되었다는 의미를 명확히 전달하기 위해서입니다.",
          },
          {
            q: "query string과 JSON body는 언제 구분해서 쓰나?",
            a: "query string은 조회 조건과 옵션, JSON body는 생성과 수정에 필요한 구조화 데이터를 담을 때 사용합니다.",
          },
        ],
      },
      {
        ...
        focus:
          "변수, 반복문, 조건문을 넘어 자동 이스케이프, 템플릿 상속, 매크로까지 다뤄 유지보수 가능한 화면 구조를 만듭니다.",
        objectives: [
...
{% endblock %}`,
        ...
        practice: {
          ...
          prompt:
            "base.html을 만들고 login.html, dashboard.html이 같은 레이아웃을 공유하게 하세요.",
          steps: [
        ...
        quiz: [
          {
            q: "템플릿 상속을 쓰는 가장 큰 이유는?",
            a: "반복되는 HTML 레이아웃을 줄이고 페이지별 변경 지점을 block으로 제한하기 위해서입니다.",
          },
          {
            q: "|safe를 조심해야 하는 이유는?",
            a: "이스케이프를 해제하여 사용자 입력이 HTML이나 스크립트로 실행될 수 있기 때문입니다.",
          },
        ],
      },
      {
        ...
        tags: ["Vue", "Axios", "CORS"],
        focus:
          "CDN 기반 Vue 화면에서 Flask API를 호출하고, 브라우저 보안 정책인 CORS를 서버 관점에서 해결합니다.",
        objectives: [
    ...
    async add() {
      ...
      this.text = ""
        ...
        practice: {
          ...
          prompt:
            "Flask Todo API를 Vue 화면에서 조회, 생성, 완료 처리까지 연결하세요.",
          steps: [
        ...
        quiz: [
          {
            q: "CORS 허용 헤더는 어디에서 설정해야 하나?",
            a: "서버 응답에서 설정해야 합니다. 브라우저는 서버의 허용 여부를 확인합니다.",
          },
          {
            q: "Vue에서 API 호출 결과를 곧바로 DOM 조작으로 처리하지 않는 이유는?",
            a: "상태를 바꾸면 Vue가 화면을 갱신하므로 데이터 흐름이 예측 가능하고 유지보수하기 쉽기 때문입니다.",
          },
        ],
      },
      {
        ...
        focus:
          "없는 페이지, 서버 오류, 요청 로그를 다루며 서비스가 실패할 때도 관찰 가능하고 친절하게 반응하도록 만듭니다.",
        objectives: [
...
def handle_http_error(error):
    return {
        ...
        practice: {
          ...
          prompt:
            "API 라우트에는 JSON 에러를, HTML 페이지에는 템플릿 에러 페이지를 반환하도록 분기해보세요.",
          steps: [
        ...
        quiz: [
          {
            q: "404와 500을 같은 방식으로 처리하면 안 되는 이유는?",
            a: "404는 클라이언트가 요청한 리소스가 없다는 정상적인 실패이고, 500은 서버 내부 오류이므로 대응 방식과 로그 중요도가 다르기 때문입니다.",
          },
          {
            q: "after_request에서 응답을 반드시 return해야 하는 이유는?",
            a: "Flask가 최종 응답 객체를 계속 사용해야 하므로 수정한 response를 반환해야 합니다.",
          },
        ],
      },
      {
        ...
        focus:
          "작은 블로그를 만들기 위해 기능을 쪼개고, MVC 관점과 Flask Blueprint로 유지보수 가능한 구조를 잡습니다.",
        objectives: [
...
def detail(post_id):
    ...
    return render_template("blog/detail.html", post=post)`,
        ...
        practice: {
          title: "블로그 기능 경계 나누기",
          prompt:
            "blog, auth, admin 세 Blueprint를 설계하고 URL 목록을 작성하세요.",
          steps: [
        ...
        quiz: [
          {
            q: "Blueprint를 쓰면 자동으로 앱이 좋아질까?",
            a: "아닙니다. 기능 경계와 책임 분리가 명확할 때 Blueprint가 효과를 냅니다.",
          },
          {
            q: "MVP에서 가장 먼저 구현할 기능은 어떻게 고르나?",
            a: "서비스의 핵심 가설을 검증하는 데 필요한 최소 사용자 흐름을 기준으로 고릅니다.",
          },
        ],
      },
      {
        ...
        focus:
          "구독 이메일처럼 구조가 안정적인 데이터와 접속 로그처럼 유연한 데이터를 구분하고, 안전한 DB 접근 패턴을 익힙니다.",
        objectives: [
...
def record_visit(path, ip):
    logs.insert_one({
        ...
        practice: {
          title: "구독과 방문 로그 구현",
          prompt:
            "이메일 구독은 MySQL, 방문 로그는 MongoDB에 저장하는 작은 데이터 계층을 설계하세요.",
          steps: [
        ...
        quiz: [
          {
            q: "파라미터 바인딩을 써야 하는 이유는?",
            a: "사용자 입력이 SQL 코드로 해석되는 SQL injection을 막고 타입 처리를 안전하게 맡기기 위해서입니다.",
          },
          {
            q: "로그 데이터를 MongoDB에 저장할 때 꼭 고려할 점은?",
            a: "조회 패턴에 맞는 인덱스와 데이터 보관 기간입니다. 로그는 빠르게 커질 수 있습니다.",
          },
        ],
      },
      {
        ...
        focus:
          "Flask-Login이 사용자 세션을 어떻게 관리하는지 이해하고, UserMixin, user_loader, login_required를 안전하게 사용합니다.",
        objectives: [
...
def logout():
    ...
    return redirect(url_for("login"))`,
        ...
        practice: {
          title: "보호 페이지 만들기",
          prompt:
            "로그인하지 않으면 접근할 수 없는 /me 페이지를 만들고, 로그인 후 현재 사용자 이메일을 보여주세요.",
          steps: [
        ...
        quiz: [
          {
            q: "user_loader는 언제 호출되나?",
            a: "세션에 저장된 사용자 id를 바탕으로 요청마다 current_user를 복원할 때 호출됩니다.",
          },
          {
            q: "비밀번호 해시를 쓰는 이유는?",
            a: "DB가 유출되어도 원래 비밀번호를 바로 알 수 없게 하기 위해서입니다.",
          },
        ],
      },
      {
        ...
        focus:
          "사각형 예제에서 출발해 웹서비스의 사용자, 글, 구독 같은 도메인 객체를 표현하는 방법으로 확장합니다.",
        objectives: [
...
print(subscription.to_row())`,
        ...
        practice: {
          title: "Post 클래스 만들기",
          prompt:
            "블로그 글을 나타내는 Post 클래스를 만들고 발행 가능 여부를 메서드로 표현하세요.",
          steps: [
        ...
        quiz: [
          {
            q: "self는 왜 필요한가?",
            a: "메서드가 어떤 객체의 속성을 읽고 바꿀지 알 수 있게 해주는 현재 객체 참조입니다.",
          },
          {
            q: "__init__에 검증을 넣는 장점은?",
            a: "객체가 잘못된 상태로 만들어지는 것을 초기에 막을 수 있습니다.",
          },
        ],
      },
      {
        ...
        focus:
          "공통 속성과 동작을 부모 클래스로 올리고, 자식 클래스가 다른 부분만 확장하는 법을 배웁니다.",
        objectives: [
          "상속과 추상화의 관계를 설명한다.",
...
print(sender.send("  Flask course started  "))`,
        ...
        practice: {
          ...
          prompt:
            "PostRenderer 부모 클래스와 HtmlRenderer, JsonRenderer 자식 클래스를 만들어보세요.",
          steps: [
        ...
        quiz: [
          {
            q: "super()를 쓰는 이유는?",
            a: "부모 클래스의 초기화나 공통 동작을 재사용하면서 자식 클래스의 추가 동작을 더하기 위해서입니다.",
          },
          {
            q: "상속보다 합성이 나은 예는?",
            a: "서비스가 저장소나 로거를 사용하는 관계처럼 is-a가 아니라 has-a 관계인 경우입니다.",
          },
        ],
      },
      {
        ...
        focus:
          "객체별 상태와 클래스 공통 상태를 구분하고, 대체 생성자와 순수 유틸리티 메서드를 적절히 배치합니다.",
        objectives: [
...
print(User.count)`,
        ...
        practice: {
          ...
          prompt:
            "Post 클래스에 from_form classmethod를 추가해 Flask request.form 데이터를 객체로 바꾸세요.",
          steps: [
        ...
        quiz: [
          {
            q: "staticmethod와 classmethod의 핵심 차이는?",
            a: "staticmethod는 아무 자동 인자를 받지 않고, classmethod는 cls를 받아 클래스 자체를 사용할 수 있습니다.",
          },
          {
            q: "변경 가능한 클래스 변수를 조심해야 하는 이유는?",
            a: "모든 인스턴스가 같은 객체를 공유해 예상치 못한 상태 공유가 생길 수 있기 때문입니다.",
          },
        ],
      },
      {
        ...
        focus:
          "라우트 함수가 모든 일을 떠안지 않도록 사용자 구독, 세션 관리, 블로그 로직을 클래스와 서비스로 분리합니다.",
        objectives: [
...
def subscribe():
    try:
        ...
        practice: {
          title: "라우트 리팩터링",
          prompt:
            "DB insert와 이메일 검증이 섞인 라우트를 SubscriptionService와 Repository로 분리하세요.",
          steps: [
        ...
        quiz: [
          {
            q: "라우트 함수가 얇아야 하는 이유는?",
            a: "HTTP 처리와 업무 규칙을 분리하면 테스트와 변경이 쉬워지고 책임이 명확해지기 때문입니다.",
          },
          {
            q: "Repository의 장점은?",
            a: "저장소 접근 세부사항을 숨겨 서비스가 업무 의미에 집중하게 하고, 테스트 대역을 넣기 쉽게 만듭니다.",
          },
        ],
      },
      {
        ...
        focus:
          "학습용 외부 공개부터 운영 배포까지 연결합니다. Apache 중심의 오래된 흐름은 이해하되, 현재는 WSGI 서버와 reverse proxy, 환경변수, 관찰 가능성을 함께 봅니다.",
        objectives: [
...
set DATABASE_URL=mysql+pymysql://user:pass@localhost/blog`,
        ...
        practice: {
          title: "배포 체크리스트 만들기",
          prompt:
            "블로그 앱을 클라우드 서버에 올린다고 가정하고 배포 전후 점검표를 작성하세요.",
          steps: [
            "필수 환경변수 목록을 적는다.",
        ...
        quiz: [
          {
            q: "Flask 개발 서버를 운영에 쓰지 않는 이유는?",
            a: "개발 편의용 서버라 운영 부하, 안정성, 보안, 프로세스 관리 요구를 충족하도록 설계되지 않았기 때문입니다.",
          },
          {
            q: "배포에서 환경변수가 중요한 이유는?",
            a: "비밀값과 환경별 설정을 코드와 분리해 보안과 재현성을 높이기 위해서입니다.",
          },
        ],
      },
    ],
